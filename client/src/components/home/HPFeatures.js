  ...
  return (
    <Accordion defaultValue="customization">
      <Accordion.Item value="customization">
        <Accordion.Control>Personal Assistant</Accordion.Control>
      ...
      <Accordion.Item value="flexibility">
        <Accordion.Control>Companion</Accordion.Control>
      ...
      <Accordion.Item value="focus-ring">
        <Accordion.Control>Mental Health & Well-Being</Accordion.Control>
